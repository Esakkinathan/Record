...
extension UIViewController {
    ...
    private static var activeToast: ToastView?
    ...
    func showToast(
        ...
        guard UIViewController.activeToast == nil else { return }
        
        let toast = ToastView(message: message, type: type)
        UIViewController.activeToast = toast
        ...
        UIView.animate(
            ...
            toast.removeFromSuperview()
            UIViewController.activeToast = nil
        }
    }
}
